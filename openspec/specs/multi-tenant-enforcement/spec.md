...
| Client contract | Contract tests/docs assert bearer token required and request `companyId` is deprecated/non-authoritative; Sprint 1 backend ignores it in favor of `req.user.firmaId`. |
